    ...
    <>
      ...
      <div className="p-4 lg:p-6 flex flex-col gap-6">
        ...
        <div className="card p-6">
          <div className="text-[9px] font-mono tracking-[0.12em] uppercase text-muted mb-3">Uygulama</div>
          <div className="text-2xl font-black tracking-[-0.04em] mb-1">
            FINTRACK<span className="text-accent">.</span>OS
          </div>
          <div className="text-xs text-muted font-mono">Kişisel Bütçe & Finans Takip Platformu · v1.0</div>
          <div className="text-xs text-muted font-mono mt-1">Veri yerel depolama (IndexedDB) üzerinde saklanır.</div>
        </div>

        {/* Demo & Reset */}
        <div className="card p-6">
          <div className="text-[9px] font-mono tracking-[0.12em] uppercase text-muted mb-4">Demo & Sıfırlama</div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start justify-between gap-4 pt-4 border-t border-line">
              <div>
                <div className="text-sm font-semibold text-danger">Tüm Veriyi Sil</div>
                <div className="text-xs text-muted mt-0.5">
