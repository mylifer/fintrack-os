...
// Converts legacy noto:/Iconify icon names → Tabler kebab-case names.
// Run every load() so Supabase is the source of truth even before any
// initDefaults migration write succeeds.
