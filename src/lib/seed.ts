...
export async function loadDemoData(): Promise<void> {
  ...
  const txs: Transaction[] = [
    ...
    // ══════════════════ JANUARY ══════════════════
    tx({ date: d(1,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Ocak Kirası', notes: 'Ev kirası — aylık ödeme', tags: ['sabit-gider'], merchant: 'Apartman Yönetimi' }),
    ...
    tx({ date: d(1,8),  type: 'expense', amount: 620,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Nusret Steakhouse', merchant: 'Nusret', familyMemberId: PRS_SPOUSE }),
    ...
    tx({ date: d(1,20), type: 'expense', amount: 480,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Çıtır Ev Yemekleri', merchant: 'Getir' }),
    ...
    tx({ date: d(1,30), type: 'expense', amount: 280,   accountId: ACC_CSH, catName: 'Yemek',  description: 'Simitçi & Kahve' }),

    // ══════════════════ FEBRUARY ══════════════════
    tx({ date: d(2,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Şubat Kirası', tags: ['sabit-gider'], merchant: 'Apartman Yönetimi' }),
    ...
    tx({ date: d(2,8),  type: 'expense', amount: 420,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Köfteci Yusuf', merchant: 'Köfteci Yusuf' }),
    ...
    tx({ date: d(2,22), type: 'expense', amount: 850,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Burger Lab', merchant: 'Burger Lab', familyMemberId: PRS_CHILD }),
    ...
    // ══════════════════ MARCH ══════════════════
    tx({ date: d(3,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Mart Kirası', tags: ['sabit-gider'] }),
    ...
    tx({ date: d(3,7),  type: 'expense', amount: 560,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Şişhane Restaurant', merchant: 'Şişhane' }),
    ...
    tx({ date: d(3,22), type: 'expense', amount: 480,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Burger King', merchant: 'Burger King', familyMemberId: PRS_CHILD }),
    ...
    // ══════════════════ APRIL ══════════════════
    tx({ date: d(4,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Nisan Kirası', tags: ['sabit-gider'] }),
    ...
    tx({ date: d(4,7),  type: 'expense', amount: 620,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Sunset Grill', merchant: 'Sunset Grill', familyMemberId: PRS_SPOUSE }),
    ...
    tx({ date: d(4,22), type: 'expense', amount: 750,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Mandabatmaz & Karaköy', merchant: 'Mandabatmaz' }),
    ...
    // ══════════════════ MAY ══════════════════
    tx({ date: d(5,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Mayıs Kirası', tags: ['sabit-gider'] }),
    ...
    tx({ date: d(5,6),  type: 'expense', amount: 480,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Fasulyeci Ali Baba', merchant: 'Fasulyeci Ali Baba' }),
    ...
    tx({ date: d(5,21), type: 'expense', amount: 920,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Zübeyir Ocakbaşı', merchant: 'Zübeyir', familyMemberId: PRS_SPOUSE }),
    ...
    tx({ date: d(5,30), type: 'expense', amount: 420,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Nişantaşı Kahvaltı', merchant: 'Gram Kahve', familyMemberId: PRS_SPOUSE }),

    // ══════════════════ JUNE ══════════════════
    tx({ date: d(6,1),  type: 'expense', amount: 18500, accountId: ACC_CHK, catName: 'Kira', description: 'Haziran Kirası', tags: ['sabit-gider'] }),
    ...
    tx({ date: d(6,7),  type: 'expense', amount: 540,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Vogue Restaurant', merchant: 'Vogue', familyMemberId: PRS_SPOUSE }),
    ...
    tx({ date: d(6,20), type: 'expense', amount: 680,   accountId: ACC_CC,  catName: 'Yemek',  description: 'Brasserie Lola', merchant: 'Brasserie Lola' }),
    tx({ date: d(6,21), type: 'expense', amount: 450,   accountId: ACC_CSH, catName: 'Yemek',  description: 'Simit Sarayı', merchant: 'Simit Sarayı' }),
...
export async function clearAllData(): Promise<void> {
  ...
  // Ödeme takibi kayıtları hesaplara/borçlara bağlı — onlar silinince yetim kalmasın.
  await db.paymentPlans.clear()
  await db.paymentOccurrences.clear()
  // Birikim hedefleri hesaplara bağlanabilir — hesaplar silinince yetim kalmasın.
  ...
  if (userId) {
    ...
    await Promise.all([
      ...
      supabase.from('payment_plans').update({ deleted_at: ts }).eq('user_id', userId),
      supabase.from('payment_occurrences').update({ deleted_at: ts }).eq('user_id', userId),
      supabase.from('savings_goals').update({ deleted_at: ts }).eq('user_id', userId),
    ])
  }
}
